...
const Select = ({ isDarkMode, setLang, Lang }) => {
    ...
    return (
    <div id='choose' className='flex-column mt-2 dark:border-b dark:border-slate-600 flex justify-evenly bg-white dark:bg-slate-800 select-none'>
        <div className='lang inline-block w-auto pl-12 cursor-pointer text-blue-700 transition-all duration-200'>
        ...
        <button className='inline-block w-auto h-auto m-2 p-2 cursor-pointer rounded-3xl hover:bg-slate-100 dark:hover:bg-slate-700 active:bg-blue-300 dark:active:bg-blue-800 btnClass'  
        ...
        <div className='lang inline-block w-aut pr-12 cursor-pointer text-blue-700'>
